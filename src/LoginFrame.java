...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(28, 122, 171));
        ...
        jButton1.setBackground(new java.awt.Color(28, 122, 171));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            String sql="select * from salesperson where username='"+username+"' and password='"+password+"'";
            ...
            if((username.equals("root"))&&(password.equals("pass"))){
                ...
                obj.setVisible(true);
                JOptionPane.showMessageDialog(this,"You have been logged in successfully!");
            }
            else if(i>0){
                dispose();
                Billing1 obj=new Billing1();
                obj.setVisible(true);
                JOptionPane.showMessageDialog(this,"You have been logged in successfully!");
            }
            else{
